...
CREATE TABLE IF NOT EXISTS set_lists (
  id          bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  gig_id      bigint REFERENCES deals(id) ON DELETE CASCADE,
  template_id bigint REFERENCES set_list_templates(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS set_list_songs (
  id           bigint GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
  set_list_id  bigint NOT NULL REFERENCES set_lists(id) ON DELETE CASCADE,
